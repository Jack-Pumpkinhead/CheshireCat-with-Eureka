...
import vulkan.buffer.MatricesBuffer
...
/**
 * Created by CowardlyLion on 2020/7/21 11:50
 */
class SetMVP(
    val vma: OzVMA,
    ...
    val model = MatricesBuffer(vma,physicalDevice)
    ...
    fun update(set: VkDescriptorSet) {
        ...
        val writeModel = WriteDescriptorSet(
            ...
            bufferInfo = arrayOf(model.descriptorBI),
            imageInfo = arrayOf()
        )
